...
import com.ayushman.WebFluxApi.customExceptions.UnAuthorizedException;
...
public class CityHandler {
    ...
    private Mono<String> sayHelloCity(ServerRequest request) {
        ...
        if (!cityParamOptional.isPresent()) {
            throw new UnAuthorizedException(HttpStatus.INTERNAL_SERVER_ERROR, "request param city is ERROR");
        }
